...
public sealed class REM : InstructionOp, ISerializeInst, IEquatable<REM?>
{
	public static readonly ParameterInfo reserved0 = new ParameterInfo(typeof(REM), 0, "reserved0", TypePatternUtility.IsIntegralScalar());
	...
	public REM(GP_REGISTER rd, GP_REGISTER rs1, ARITHMETIC_FUNCTION funct5, GP_REGISTER rs2)
	{
		this.rd = rd;
		this.rs1 = rs1;
		this.funct5 = funct5;
	...
	public REM With(GP_REGISTER? rd = null, GP_REGISTER? rs1 = null, ARITHMETIC_FUNCTION? funct5 = null, GP_REGISTER? rs2 = null)
	{
		return new REM(rd ?? this.rd, rs1 ?? this.rs1, funct5 ?? this.funct5, rs2 ?? this.rs2);
	}

	public override bool Equals(object? obj)
	{
		return Equals(obj as REM);
	}
