...
public sealed class SH : InstructionOp, ISerializeInst, IEquatable<SH?>
{
	public static readonly ParameterInfo offset = new ParameterInfo(typeof(SH), 0, "offset", TypePatternUtility.IsIntegralScalar());
	...
	public SH(GP_REGISTER rd, GP_REGISTER rs, STORE_FUNCTION funct3)
	{
		this.rd = rd;
		this.rs = rs;
		this.funct3 = funct3;
	...
	public SH With(GP_REGISTER? rd = null, GP_REGISTER? rs = null, STORE_FUNCTION? funct3 = null)
	{
		return new SH(rd ?? this.rd, rs ?? this.rs, funct3 ?? this.funct3);
	}

	public override bool Equals(object? obj)
	{
		return Equals(obj as SH);
	}

	public bool Equals(SH? other)
	{
