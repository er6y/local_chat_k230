...
public sealed class LH : InstructionOp, ISerializeInst, IEquatable<LH?>
{
	public static readonly ParameterInfo offset = new ParameterInfo(typeof(LH), 0, "offset", TypePatternUtility.IsIntegralScalar());
	...
	public LH(GP_REGISTER rd, GP_REGISTER rs, LOAD_FUNCTION funct3)
	{
		this.rd = rd;
		this.rs = rs;
		this.funct3 = funct3;
	...
	public LH With(GP_REGISTER? rd = null, GP_REGISTER? rs = null, LOAD_FUNCTION? funct3 = null)
	{
		return new LH(rd ?? this.rd, rs ?? this.rs, funct3 ?? this.funct3);
	}

	public override bool Equals(object? obj)
	{
		return Equals(obj as LH);
	}

	public bool Equals(LH? other)
	{
