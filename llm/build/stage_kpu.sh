...
set -e
STAGE=/mnt/d/work/git_dev/k230_prj/k230_llm/llm/build/stage_kpu
rm -rf $STAGE
...
cp /mnt/d/work/git_dev/k230_prj/k230_llm/llm/eval/m1/kpu_run $STAGE/kpu_llm/ 2>/dev/null || true
python3 - <<'EOF'
import numpy as np
x = np.load("/tmp/kpu_poc/qwen/l0_gate.probe_x.npy")
x.tofile("/mnt/d/work/git_dev/k230_prj/k230_llm/llm/build/stage_kpu/l0_gate.probe_x.bin")
