...
cd /mnt/d/work/git_dev/local_chat_k230/downloads/MNN/transformers/llm/export
rm -rf /mnt/d/work/git_dev/local_chat_k230/models/Qwen3-0.6B-MNN-8bit
python3 llmexport.py \
  --path /mnt/d/work/git_dev/local_chat_k230/models/Qwen3-0.6B-hf \
  --export mnn --quant_bit 8 \
  --dst_path /mnt/d/work/git_dev/local_chat_k230/models/Qwen3-0.6B-MNN-8bit \
  2>&1 | tail -6
ls -la /mnt/d/work/git_dev/local_chat_k230/models/Qwen3-0.6B-MNN-8bit/
