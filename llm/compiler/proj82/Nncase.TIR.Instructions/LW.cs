...
public sealed class LW : InstructionOp, ISerializeInst, IEquatable<LW?>
{
	public static readonly ParameterInfo offset = new ParameterInfo(typeof(LW), 0, "offset", TypePatternUtility.IsIntegralScalar());
	...
	public LW(GP_REGISTER rd, GP_REGISTER rs, LOAD_FUNCTION funct3)
	{
		this.rd = rd;
		this.rs = rs;
		this.funct3 = funct3;
	...
	public LW With(GP_REGISTER? rd = null, GP_REGISTER? rs = null, LOAD_FUNCTION? funct3 = null)
	{
		return new LW(rd ?? this.rd, rs ?? this.rs, funct3 ?? this.funct3);
	}

	public override bool Equals(object? obj)
	{
		return Equals(obj as LW);
	}

	public bool Equals(LW? other)
	{
