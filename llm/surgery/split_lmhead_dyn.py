...
m = onnx.load('/root/qwen25_4layer/onnx/llm_single.onnx', load_external_data=True)
g = m.graph
...
m2 = m
onnx.save_model(m2, '/root/qwen25_4layer/onnx/llm_split.onnx', save_as_external_data=False)
