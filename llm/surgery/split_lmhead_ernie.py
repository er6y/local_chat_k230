...
m = onnx.load('/root/ernie_pipe/onnx/llm.onnx', load_external_data=True)
g = m.graph
...
m2 = m
onnx.save_model(m2, '/root/ernie_split.onnx', save_as_external_data=False)
