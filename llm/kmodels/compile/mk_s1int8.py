...
GGUF = "/mnt/d/work/git_dev/k230_prj/local_chat_k230/models/qwen3_06b_gguf/Qwen3-0.6B-Q8_0_q6k_tied.gguf"
OUTDIR = "/mnt/d/work/git_dev/k230_prj/local_chat_k230/llm/kmodels/s1int8"
S = 1
NLAYERS = 28
N_CAL = 4
...
def calc_smooth_s(tag, IN, S, alpha=0.5):
    ...
    for p in sorted(_glob.glob(f"/tmp/kpu_poc/calib1_clean/{tag}_*.npy")):
